...
const std::array<std::u32string, 10> InfoText::Keys32 = {{
        U"font",
        U"cSize",
        U"leSpace",
        U"liSpace",
...
template<> InfoText::Typer<InfoText::Info::FONT>::Type                InfoText::getInfo<InfoText::Info::FONT>()                const
{
    return font;
}
template<> InfoText::Typer<InfoText::Info::CHAR_SIZE>::Type           InfoText::getInfo<InfoText::Info::CHAR_SIZE>()           const
{
    return charSize;
}
template<> InfoText::Typer<InfoText::Info::LETTER_SPACING>::Type      InfoText::getInfo<InfoText::Info::LETTER_SPACING>()      const
{
    return letterSpacing;
}
template<> InfoText::Typer<InfoText::Info::LINE_SPACING_FACTOR>::Type InfoText::getInfo<InfoText::Info::LINE_SPACING_FACTOR>() const
{
    return lineSpacingFactor;
}
template<> InfoText::Typer<InfoText::Info::STYLE>::Type               InfoText::getInfo<InfoText::Info::STYLE>()               const
{
    return style;
}
template<> InfoText::Typer<InfoText::Info::FILL_COLOR>::Type          InfoText::getInfo<InfoText::Info::FILL_COLOR>()          const
{
    return fillColor;
}
template<> InfoText::Typer<InfoText::Info::OUTLINE_COLOR>::Type       InfoText::getInfo<InfoText::Info::OUTLINE_COLOR>()       const
{
    return outlineColor;
}
template<> InfoText::Typer<InfoText::Info::BACK_COLOR>::Type          InfoText::getInfo<InfoText::Info::BACK_COLOR>()          const
{
    return backColor;
}
template<> InfoText::Typer<InfoText::Info::SIZE_BACK>::Type           InfoText::getInfo<InfoText::Info::SIZE_BACK>()           const
{
    return sizeBack;
}
template<> InfoText::Typer<InfoText::Info::THICKNESS>::Type           InfoText::getInfo<InfoText::Info::THICKNESS>()           const
{
    return thickness;
}

template<> void InfoText::setInfo<InfoText::Info::FONT>(InfoText::Typer<InfoText::Info::FONT>::Type t)
{
    font = t;
}
template<> void InfoText::setInfo<InfoText::Info::CHAR_SIZE>(InfoText::Typer<InfoText::Info::CHAR_SIZE>::Type t)
{
    charSize = t;
}
template<> void InfoText::setInfo<InfoText::Info::LETTER_SPACING>(InfoText::Typer<InfoText::Info::LETTER_SPACING>::Type t)
{
    letterSpacing = t;
}
template<> void InfoText::setInfo<InfoText::Info::LINE_SPACING_FACTOR>(InfoText::Typer<InfoText::Info::LINE_SPACING_FACTOR>::Type t)
{
    lineSpacingFactor = t;
}
template<> void InfoText::setInfo<InfoText::Info::STYLE>(InfoText::Typer<InfoText::Info::STYLE>::Type t)
{
    style = t;
}
template<> void InfoText::setInfo<InfoText::Info::FILL_COLOR>(InfoText::Typer<InfoText::Info::FILL_COLOR>::Type t)
{
    fillColor = t;
}
template<> void InfoText::setInfo<InfoText::Info::OUTLINE_COLOR>(InfoText::Typer<InfoText::Info::OUTLINE_COLOR>::Type t)
{
    outlineColor = t;
}
template<> void InfoText::setInfo<InfoText::Info::BACK_COLOR>(InfoText::Typer<InfoText::Info::BACK_COLOR>::Type t)
{
    backColor = t;
}
template<> void InfoText::setInfo<InfoText::Info::SIZE_BACK>(InfoText::Typer<InfoText::Info::SIZE_BACK>::Type t)
{
    sizeBack = t;
}
template<> void InfoText::setInfo<InfoText::Info::THICKNESS>(InfoText::Typer<InfoText::Info::THICKNESS>::Type t)
{
    thickness = t;
}
